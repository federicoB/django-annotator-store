...
project = u'django-annotator-store'
copyright = u'2017, CDH @ Princeton University'
...
version = '%d.%d' % annotator_store.__version_info__[:2]
# The full version, including alpha/beta/rc tags.
release = annotator_store.__version__
...
man_pages = [
    ('index', 'django-annotator-store', u'django-annotator-store documentation',
     [u'CDH @ Princeton'], 1)
]
...
texinfo_documents = [
  ('index', 'django-annotator-store', u'django-annotator-store documentation',
   u'CDH @ Princeton', 'django-annotator-store',
